        ...
        <div id="memLoginTab_HC">
            ...
            <div id="tab01_HC" class="memTabCon_HC memTabClass_HC">
                <form name="form1" action="" method="post">
                    ...
                    <div class="memColumn_HC">
                        <p>帳號</p>
                        <input onkeyup="check()" type="email" placeholder="請輸入信箱" class="memEmailCheck_HC memAccountEmail_HC" name="email">
                    ...
                    <!-- 登入按鈕 -->
                    <button class="wBtnNGr memBtnShare_HC memLoginBtn">登入</button>
                </form>
            ...
            <div id="tab02_HC" class="memTabCon_HC memTabClass_HC">
                <form name="form2" action="" method="post">
                    ...
                    <div class="memColumn_HC">
                        <p>帳號</p>
                        <input onkeyup="check2()" type="email" placeholder="請輸入信箱" class="memEmailCheck2_HC memNI_HC memAccountEmail_HC" name="email">
                        <div class="memErroCSS_HC">
                    ...
                    <label class="memCheck_HC">
                        <input type="checkbox" class="memChecking_HC" name="check">
                        <p>我同意UPICK的<button class="memServBox_HC" type="button">《服務條款》</button>、<button class="memPrivacyBox_HC" type="button">《隱私權政策》</button>。
                        </p>
                    </label>
                    <button class="wBtnNGr memBtnShare_HC memRegisterBtn" onclick="">加入會員</button>
                </form>
                <div class="memErroCSS_HC memNoInput_HC">
                    <i class="fas fa-exclamation-circle"> 帳號/密碼/確認密碼 未填寫！</i>
                </div>
                <div class="memErroCSS_HC memNoCheck_HC">
...
<script>
    ...
    const checking = document.querySelector('.memChecking_HC');
    const noCheck = document.querySelector('.memNoCheck_HC');
    Succ.onclick = function(e) {
        e.preventDefault();
        if (email2.value == "") {
